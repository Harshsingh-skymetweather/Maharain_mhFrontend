...
@Component({
  selector: 'app-distmonth-wise',
  templateUrl: './distmonth-wise.component.html',
  styleUrls: ['./distmonth-wise.component.scss']
})
export class DistmonthWiseComponent implements OnInit {
  divisions:any;
  reports:any= [];
  statereports:any=[];
...
calculatePercentage(dataArray: any[]): number {
    ...
    return totalNormal !== 0 ? Math.round((totalActual / totalNormal) * 100) / 10 : 0;
