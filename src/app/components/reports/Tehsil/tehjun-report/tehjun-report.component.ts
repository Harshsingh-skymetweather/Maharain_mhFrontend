...
@Component({
  selector: 'app-tehjun-report',
  templateUrl: './tehjun-report.component.html',
  styleUrls: ['./tehjun-report.component.scss']
})
export class TehjunReportComponent implements OnInit {
    ...
    return selectedDivisionData ? selectedDivisionData.division_name : '';
     ...
     onSubmit() {
      if(this.selectedState == ''){
       ...
       {
     this.currentreport.tehsilJunReport(this.selectedDivision,this.selectedDistrict).subscribe((res) => {
