...
@Component({
  selector: 'app-tehmonthwise',
  templateUrl: './tehmonthwise.component.html',
  styleUrls: ['./tehmonthwise.component.scss']
})
export class TehmonthwiseComponent implements OnInit {
