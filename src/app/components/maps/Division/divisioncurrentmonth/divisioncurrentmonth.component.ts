...
@Component({
  selector: 'app-divisioncurrentmonth',
  templateUrl: './divisioncurrentmonth.component.html',
  styleUrls: ['./divisioncurrentmonth.component.scss']
})
export class DivisioncurrentmonthComponent implements OnInit {
