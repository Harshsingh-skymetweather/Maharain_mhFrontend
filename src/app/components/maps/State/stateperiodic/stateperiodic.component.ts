...
@Component({
  selector: 'app-stateperiodic',
  templateUrl: './stateperiodic.component.html',
  styleUrls: ['./stateperiodic.component.scss']
})
export class StateperiodicComponent implements OnInit {
  ...
  onSubmit() {
    if (this.fromDate !== null && this.toDate !== null) {
       ...
       this.formattedToDate = this.toDate.replace(/-/g, '');

      console.log(this.formattedFromDate, 'fromdate');
      console.log(this.formattedToDate, 'todate');
  ...
  private initMap(): void {
    ...
    L.tileLayer.wms('https://geo.skymetweather.com/geoserver/cite/wms', {
      ...
      viewparams: `from_date:${this.formattedFromDate};to_date:${this.formattedToDate}`
