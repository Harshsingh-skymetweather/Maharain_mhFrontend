...
@Component({
  selector: 'app-district-current-month',
  templateUrl: './district-current-month.component.html',
  styleUrls: ['./district-current-month.component.scss']
})
export class DistrictCurrentMonthComponent implements OnInit {
  ...
  private initMap(): void {
    this.title = 'Circle wise Rainfall of  district (as compared to normal rain) for the month of Nov';
    if (!this.map) {
