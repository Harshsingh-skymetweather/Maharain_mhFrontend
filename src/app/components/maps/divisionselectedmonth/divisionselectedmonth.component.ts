...
@Component({
  selector: 'app-divisionselectedmonth',
  templateUrl: './divisionselectedmonth.component.html',
  styleUrls: ['./divisionselectedmonth.component.scss']
})
export class DivisionselectedmonthComponent implements OnInit {
  ...
  private initMap(): void {
    ...
    this.circleIntensityLayer = L.tileLayer.wms('http://geo.skymetweather.com:8081/geoserver/cite/wms', {
      ...
      CQL_FILTER: `district_code in (${districtCodes}) AND int_month=${currentMonth}`
    });
