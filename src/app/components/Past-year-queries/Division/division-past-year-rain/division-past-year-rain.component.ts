...
@Component({
  selector: 'app-division-past-year-rain',
  templateUrl: './division-past-year-rain.component.html',
  styleUrls: ['./division-past-year-rain.component.scss']
})
export class DivisionPastYearRainComponent implements OnInit {
