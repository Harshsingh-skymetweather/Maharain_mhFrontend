...
@Component({
  selector: 'app-district-pastyear-monthydist-rain',
  templateUrl: './district-pastyear-monthydist-rain.component.html',
  styleUrls: ['./district-pastyear-monthydist-rain.component.scss']
})
export class DistrictPastyearMonthydistRainComponent implements OnInit {
  divisions:any;
  reports:any= [];
  statereports:any=[];
