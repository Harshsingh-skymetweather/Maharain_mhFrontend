...
@Component({
  selector: 'app-district-pastyear-heavyrainfallcount',
  templateUrl: './district-pastyear-heavyrainfallcount.component.html',
  styleUrls: ['./district-pastyear-heavyrainfallcount.component.scss']
})
export class DistrictPastyearHeavyrainfallcountComponent implements OnInit {
  ...
  onSubmit() {
    console.log(this.selectedYear,'year')
      this.service.Districtheavyrainfallcount(this.selectedYear,this.selectedDivision,this.selectedDistrict).subscribe((res) => {
        this.inputData = res;
