...
@Component({
  selector: 'app-tehsil-percentage-current-month',
  templateUrl: './tehsil-percentage-current-month.component.html',
  styleUrls: ['./tehsil-percentage-current-month.component.scss']
})
export class TehsilPercentageCurrentMonthComponent implements OnInit {
