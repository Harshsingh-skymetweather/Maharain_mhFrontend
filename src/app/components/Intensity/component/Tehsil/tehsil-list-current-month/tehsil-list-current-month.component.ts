...
@Component({
  selector: 'app-tehsil-list-current-month',
  templateUrl: './tehsil-list-current-month.component.html',
  styleUrls: ['./tehsil-list-current-month.component.scss']
})
export class TehsilListCurrentMonthComponent implements OnInit {
  selectedMonth:any='';
  result:any;
  selectedyear:any='';
  groupedData: any = {};
