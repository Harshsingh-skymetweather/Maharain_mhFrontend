...
@Component({
  selector: 'app-tehsil-count-current-month',
  templateUrl: './tehsil-count-current-month.component.html',
  styleUrls: ['./tehsil-count-current-month.component.scss']
})
export class TehsilCountCurrentMonthComponent implements OnInit {
