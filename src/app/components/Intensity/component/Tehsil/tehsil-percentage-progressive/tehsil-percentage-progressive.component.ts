...
@Component({
  selector: 'app-tehsil-percentage-progressive',
  templateUrl: './tehsil-percentage-progressive.component.html',
  styleUrls: ['./tehsil-percentage-progressive.component.scss']
})
export class TehsilPercentageProgressiveComponent implements OnInit {
  ...
  transformData() {
    ...
    this.selectDivisionName = this.selectedDivisionName;
     console.log(this.selectedDivisionName,'ujhj')
    this.intensity.getTehsilPercentageProgressive(this.selDivisionCode,this.selectedMonth).subscribe((res) => {
