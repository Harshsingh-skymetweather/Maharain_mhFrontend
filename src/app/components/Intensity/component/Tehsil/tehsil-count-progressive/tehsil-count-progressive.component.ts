...
@Component({
  selector: 'app-tehsil-count-progressive',
  templateUrl: './tehsil-count-progressive.component.html',
  styleUrls: ['./tehsil-count-progressive.component.scss']
})
export class TehsilCountProgressiveComponent implements OnInit {
