...
@Component({
  selector: 'app-countprogressive',
  templateUrl: './countprogressive.component.html',
  styleUrls: ['./countprogressive.component.scss']
})
export class CountprogressiveComponent implements OnInit {
