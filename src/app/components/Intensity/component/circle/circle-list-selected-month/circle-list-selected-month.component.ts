...
@Component({
  selector: 'app-circle-list-selected-month',
  templateUrl: './circle-list-selected-month.component.html',
  styleUrls: ['./circle-list-selected-month.component.scss']
})
export class CircleListSelectedMonthComponent implements OnInit {
