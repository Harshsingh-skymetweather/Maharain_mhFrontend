...
@Component({
  selector: 'app-circle-count-current-month',
  templateUrl: './circle-count-current-month.component.html',
  styleUrls: ['./circle-count-current-month.component.scss']
})
export class CircleCountCurrentMonthComponent implements OnInit {
