...
@Component({
  selector: 'app-dist-list-progressive',
  templateUrl: './dist-list-progressive.component.html',
  styleUrls: ['./dist-list-progressive.component.scss']
})
export class DistListProgressiveComponent implements OnInit {
...
ngOnInit() {
 ...
 onSubmit() {
    this.service.districtcountlistProgreesive(this.selectedMonth).subscribe((res) => {
      this.result = res;
