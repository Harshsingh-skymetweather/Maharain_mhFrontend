...
@Component({
  selector: 'app-dist-count-progressive',
  templateUrl: './dist-count-progressive.component.html',
  styleUrls: ['./dist-count-progressive.component.scss']
})
export class DistCountProgressiveComponent implements OnInit {
  today: Date = new Date();
  total:any;
  count:any;
  result: any[] = [];
  ...
  getmodifiedresult(){
    this.service.districtcountlistProgreesive(this.selectedMonth).subscribe((res:any)=>{
      this.result = res
