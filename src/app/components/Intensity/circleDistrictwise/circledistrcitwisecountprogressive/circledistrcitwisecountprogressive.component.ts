...
@Component({
  selector: 'app-circledistrcitwisecountprogressive',
  templateUrl: './circledistrcitwisecountprogressive.component.html',
  styleUrls: ['./circledistrcitwisecountprogressive.component.scss']
})
export class CircledistrcitwisecountprogressiveComponent implements OnInit {
  ...
  onSubmit() {
    this.Intensityservice.districtwisecirclecountProgressive().subscribe((res) => {
