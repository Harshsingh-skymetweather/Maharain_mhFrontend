...
@Component({
  selector: 'app-pastyeartehsilintensity',
  templateUrl: './pastyeartehsilintensity.component.html',
  styleUrls: ['./pastyeartehsilintensity.component.scss']
})
export class PastyeartehsilintensityComponent implements OnInit {
  ...
  transformData() {
    ...
    this.intensity.getTehsilPastPercentageintensityData(this.selectedYear,this.selDivisionCode, this.selectedMonth).subscribe((res) => {
