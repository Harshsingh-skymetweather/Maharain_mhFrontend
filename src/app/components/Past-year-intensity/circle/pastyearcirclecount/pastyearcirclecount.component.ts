...
@Component({
  selector: 'app-pastyearcirclecount',
  templateUrl: './pastyearcirclecount.component.html',
  styleUrls: ['./pastyearcirclecount.component.scss']
})
export class PastyearcirclecountComponent implements OnInit {
  selectedYear:any='';
  selectedMonth:any='';
  ...
  onSubmit(){
    if(this.selectedMonth!='' && this.selectedYear!='')
    {
      ...
      this.service.CirclePastIntensitylistandCount(this.selectedYear,this.selectedMonth).subscribe((res) => {
