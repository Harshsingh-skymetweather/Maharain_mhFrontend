...
@Component({
  selector: 'app-tehdailyrain',
  templateUrl: './tehdailyrain.component.html',
  styleUrls: ['./tehdailyrain.component.scss']
})
export class TehdailyrainComponent implements OnInit {
