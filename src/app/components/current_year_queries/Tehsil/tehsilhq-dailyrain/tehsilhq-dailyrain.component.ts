...
@Component({
  selector: 'app-tehsilhq-dailyrain',
  templateUrl: './tehsilhq-dailyrain.component.html',
  styleUrls: ['./tehsilhq-dailyrain.component.scss']
})
export class TehsilhqDailyrainComponent implements OnInit {
  ...
  onSubmit() {
    if(this.selectedState == ''){
     ...
     {
      console.log(this.currentMonthIndex+1,'currentmonth')
      this.currentqueries.TehsilheadquarterDailyrain(this.selectedYear,this.selectedDivision,this.selectedDistrict,this.currentMonthIndex+1).subscribe((res) => {
