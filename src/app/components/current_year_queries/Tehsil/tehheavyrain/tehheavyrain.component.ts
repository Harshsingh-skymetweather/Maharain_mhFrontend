...
@Component({
  selector: 'app-tehheavyrain',
  templateUrl: './tehheavyrain.component.html',
  styleUrls: ['./tehheavyrain.component.scss']
})
export class TehheavyrainComponent implements OnInit {
  divisions:any;
  districts:any;
  statereports:any=[];
  today:any=new Date();
