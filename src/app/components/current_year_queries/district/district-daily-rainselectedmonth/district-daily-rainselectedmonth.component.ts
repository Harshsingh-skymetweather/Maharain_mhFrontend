...
@Component({
  selector: 'app-district-daily-rainselectedmonth',
  templateUrl: './district-daily-rainselectedmonth.component.html',
  styleUrls: ['./district-daily-rainselectedmonth.component.scss']
})
export class DistrictDailyRainselectedmonthComponent implements OnInit {
