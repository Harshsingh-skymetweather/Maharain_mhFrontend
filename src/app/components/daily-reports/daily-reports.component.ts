...
export class DailyReportsComponent implements OnInit {
  ...
  onBtnExport() {
    ...
    a.download = 'daily_report.csv';  // Name of the CSV file
  ...
  onSubmit() {
    if (this.selectedDivision && this.selectedDistrict && this.fromDate && this.toDate) {
      ...
      this.service.getdailyReport(this.selectedDivision, this.selectedDistrict, this.selectedTehsil, this.selectedCircle, this.selectedstation, this.fromDate, this.toDate).subscribe((res) => {
        this.result = res;
